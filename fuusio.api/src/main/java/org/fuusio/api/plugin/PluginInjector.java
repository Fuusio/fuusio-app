...
/**
 * {@link PluginInjector} defines an interface for objects that can be used to inject additional
 * {@link Plugin}s when a given {@link Plugin} is plugged to {@link PluginBus}.
 */
